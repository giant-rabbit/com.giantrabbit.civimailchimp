...
class CRM_CiviMailchimp_MiscTest extends CiviUnitTestCase {
  ...
  function test_civimailchimp_civicrm_contact_added_to_group_email_null() {
    $group_name = 'Test Group test_contact_added_to_group_email_null';
  ...
  function test_civimailchimp_civicrm_contact_removed_from_group_email_null() {
    $group_name = 'Test Group test_contact_removed_from_group_email_null';
    $group_id = $this->groupCreate(array('name' => $group_name, 'title' => $group_name));
    $group = CRM_CiviMailchimp_Utils::getGroupById($group_id);
    $params = CRM_CiviMailchimp_UtilsTest::sampleContactParams();
    unset($params['email']);
  ...
  function test_civimailchimp_civicrm_contact_updated_no_email_null() {
    civimailchimp_static('mailchimp_do_not_run_hooks', TRUE);
    $mailchimp_list_id = 'MailchimpListsTestListA';
    $mailchimp_sync_setting = CRM_CiviMailchimp_BAO_SyncSettingsTest::createTestGroupAndSyncSettings('Test Group civicrm_contact_updated_no_email_null', $mailchimp_list_id);
    ...
    civimailchimp_static('mailchimp_do_not_run_hooks', FALSE);
    ...
    $this->assertEquals($mailchimp_list_id, $item->data->arguments[1]);
    $this->assertEquals($new_contact_params['email'][0]['email'], $item->data->arguments[2]);
  }

  function test_civimailchimp_civicrm_contact_updated_old_email_null() {
    civimailchimp_static('mailchimp_do_not_run_hooks', TRUE);
    $mailchimp_list_id = 'MailchimpListsTestListA';
    $mailchimp_sync_setting = CRM_CiviMailchimp_BAO_SyncSettingsTest::createTestGroupAndSyncSettings('Test Group civicrm_contact_updated_old_email_null', $mailchimp_list_id);
    $mailchimp_sync_settings = array($mailchimp_sync_setting);
    $old_contact_params = CRM_CiviMailchimp_UtilsTest::sampleContactParams();
    $new_contact_params = $old_contact_params;
    unset($old_contact_params['email']);
    $old_contact_created = CRM_Contact_BAO_Contact::create($old_contact_params);
    $old_contact = CRM_CiviMailchimp_Utils::getContactById($old_contact_created->id);
    $contact_ids = array($old_contact->id);
    CRM_Contact_BAO_GroupContact::addContactsToGroup($contact_ids, $mailchimp_sync_setting->civicrm_group_id);
  ...
  function test_civimailchimp_civicrm_contact_updated_new_email_null() {
    civimailchimp_static('mailchimp_do_not_run_hooks', TRUE);
    $mailchimp_list_id = 'MailchimpListsTestListA';
    $mailchimp_sync_setting = CRM_CiviMailchimp_BAO_SyncSettingsTest::createTestGroupAndSyncSettings('Test Group civicrm_contact_updated_new_email_null', $mailchimp_list_id);
    $mailchimp_sync_settings = array($mailchimp_sync_setting);
    $old_contact_params = CRM_CiviMailchimp_UtilsTest::sampleContactParams();
    $new_contact_params = $old_contact_params;
    $old_contact_created = CRM_Contact_BAO_Contact::create($old_contact_params);
  ...
  function test_civimailchimp_civicrm_contact_updated_both_email_null() {
    civimailchimp_static('mailchimp_do_not_run_hooks', TRUE);
    $mailchimp_list_id = 'MailchimpListsTestListA';
    $mailchimp_sync_setting = CRM_CiviMailchimp_BAO_SyncSettingsTest::createTestGroupAndSyncSettings('Test Group civicrm_contact_updated_both_email_null', $mailchimp_list_id);
    $mailchimp_sync_settings = array($mailchimp_sync_setting);
    $old_contact_params = CRM_CiviMailchimp_UtilsTest::sampleContactParams();
    unset($old_contact_params['email']);
    $new_contact_params = $old_contact_params;
  ...
  function test_civimailchimp_civicrm_pre_individual_edit() {
    ...
    civimailchimp_civicrm_pre($op, $object_name, $contact->id, $contact);
    $old_contact = civimailchimp_static('old_contact');
    $this->assertEquals($contact->id, $old_contact->id);
  }

  function test_civimailchimp_civicrm_pre_email_no_op() {
    $op = 'edit';
    $object_name = 'Email';
    $params = CRM_CiviMailchimp_UtilsTest::sampleContactParams();
    $contact_created = CRM_Contact_BAO_Contact::create($params);
    ...
    $email['contact_id'] = $contact->id;
    civimailchimp_static('mailchimp_static_reset', NULL, TRUE);
    civimailchimp_civicrm_pre($op, $object_name, $email_id, $email);
    $old_contact_from_email = civimailchimp_static('old_contact_from_email');
    $this->assertEquals($contact->id, $old_contact_from_email->id);
  }

  function test_civimailchimp_civicrm_post_individual_delete() {
    $op = 'delete';
    $object_name = 'Individual';
    $mailchimp_list_id = 'MailchimpListsTestListA';
    ...
    civimailchimp_civicrm_post($op, $object_name, $contact->id, $contact);
    $item = $queue->claimItem();
    $this->assertEquals('unsubscribeContactFromMailchimpList', $item->data->arguments[0]);
    $this->assertEquals($mailchimp_list_id, $item->data->arguments[1]);
    $this->assertEquals($params['email'][0]['email'], $item->data->arguments[2]);
  ...
  function test_civimailchimp_static() {
    civimailchimp_static('test_civimailchimp_static', TRUE);
    $test_civimailchimp_static = civimailchimp_static('test_civimailchimp_static');
    $this->assertTrue($test_civimailchimp_static);
  }
